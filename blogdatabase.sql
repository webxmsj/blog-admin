...
-- ----------------------------
INSERT INTO `blog_comment` VALUES (82, NULL, 33, NULL, 1, 1, 0, 1541746458732, NULL, 1, 'heartdream', 'null', '0', 12, '写较少的if判断，可以优化阅读体验', NULL, 0);
...
-- ----------------------------
INSERT INTO `blog_link` VALUES (1, 1, 0, 10000, '百度首页', 'http://www.baidu.com', '百度', '', '_blank', '', 0);
INSERT INTO `blog_link` VALUES (2, 0, 0, 10000, 'asdfas', 'asdfa', 'fasdfasd', '', 'da', '', 1);
INSERT INTO `blog_link` VALUES (3, 0, 1, 2, '修改了乐视的简介', 'http://www.le.com', '乐视视频', 'http://www.lethis.com/q.jpg', '_blank', '', 0);
